...
export function HeroSection(props: HeroSectionProps) {
  return (
    <section className="md:bgDesktopVendaMaisComANeide lg:bgDesktopVendaMaisComANeide hero min-h-min bg-bgMobileVendaMaisComANeide bg-cover bg-fixed bg-center bg-no-repeat sm:bg-bgDesktopVendaMaisComANeide sm:bg-cover md:bg-cover lg:bg-cover">
      <div
...
export function HeroCard(props: HeroCardProps) {
  return (
    <div className="bg-black/60 backdrop-blur-sm sm:bg-transparent sm:backdrop-blur-none max-w-fit rounded-lg card-compact h-auto w-full min-w-full">
...
export function HeroCardH1(props: HeroCardH1Props) {
  return (
    <h1
      className="mt-0 sm:mt-4 pb-2 text-lg uppercase font-extrabold text-white drop-shadow-lg md:text-3xl"
      {...props}
    />
  )
}
...
export function HeroCardH1Span(props: HeroCardH1SpanProps) {
  return (
    <span
      className="bg-clip-text font-black text-transparent bg-brandVendaMaisComANeideOne"
      {...props}
    />
  )
}
