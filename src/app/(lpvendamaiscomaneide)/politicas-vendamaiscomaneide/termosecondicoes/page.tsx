...
export default function Home() {
  return (
    <>
      <title>Termos e Condições | Venda Mais Com A Neide 4.0</title>
      <div className="grid h-auto max-w-full place-content-center bg-zinc-950 px-4">
        <div className="text-center max-w-4xl pt-32 pb-10 space-y-4">
          ...
          <p className="text-zinc-200 text-justify text-sm sm:text-base">
            Ao acessar ao site Venda Mais Com A Neide 4.0, concorda em cumprir
          ...
          <p className="text-zinc-200 text-justify text-sm sm:text-base">
            ...
            materiais (informações ou software) no site Venda Mais Com A Neide
            4.0 , apenas para visualização transitória pessoal e não comercial.
          ...
          <ul className="list-decimal text-justify text-zinc-200 text-sm sm:text-base">
            ...
            <li className="list-inside indent-8">
              ...
              software contido no site Venda Mais Com A Neide 4.0;
            </li>
            <li className="list-inside indent-8">
          ...
          <ul className="list-decimal text-justify text-zinc-200 text-sm sm:text-base">
            <li className="list-inside indent-8">
              Os materiais no site da Venda Mais Com A Neide 4.0 são fornecidos
              'como estão'. Venda Mais Com A Neide 4.0 não oferece garantias,
            ...
            <li className="list-inside indent-8">
              Além disso, o Venda Mais Com A Neide 4.0 não garante ou faz
          ...
          <p className="text-zinc-200 text-justify text-sm sm:text-base">
            Em nenhum caso o Venda Mais Com A Neide 4.0 ou seus fornecedores
          ...
          <p className="text-zinc-200 text-justify text-sm sm:text-base">
            O Venda Mais Com A Neide 4.0 não analisou todos os sites vinculados
            ao seu site e não é responsável pelo conteúdo de nenhum site
            vinculado. A inclusão de qualquer link não implica endosso por Venda
            Mais Com A Neide 4.0 do site. O uso de qualquer site vinculado é por
          ...
          <p className="text-zinc-200 text-justify text-sm sm:text-base">
            O Venda Mais Com A Neide 4.0 pode revisar estes termos de serviço do
          ...
          <p className="text-zinc-200 text-justify text-sm sm:text-base pb-4">
            ...
            as leis do Venda Mais Com A Neide 4.0 e você se submete
