      ...
      <div className="grid h-auto max-w-full place-content-center bg-zinc-950 px-4">
        <div className="text-center max-w-4xl pt-32 pb-10 space-y-4">
          ...
          <p className="text-zinc-200 text-justify text-sm sm:text-base">
            A sua privacidade é importante para nós. É política do Genograma
            Expert 2.0 respeitar a sua privacidade em relação a qualquer
            informação sua que possamos coletar no site Genograma Expert 2.0, e
          ...
          <ul className="list-disc text-justify text-zinc-200 text-sm sm:text-base">
          ...
          <p className="text-zinc-200 text-justify text-sm sm:text-base">
            ...
            informação que o Genograma Expert 2.0 oferece no site e com caráter
          ...
          <ul className="list-disc text-justify text-zinc-200 text-sm sm:text-base">
            ...
            <li className="list-inside indent-8">
              ...
              (softwares) do Genograma Expert 2.0, de seus fornecedores ou
