...
export default function Home() {
  return (
    <>
      <title>Política de Privacidade | Políticas Brow Extension Pro</title>
      <GridProperty>
        <RootProperty>
          ...
          <Paragraph>
            ...
            informação sua que possamos coletar no site Brow Extension Pro 4.0,
          ...
          <Paragraph>
            ...
            informação que o Brow Extension Pro 4.0 oferece no site e com
          ...
          <UlProperty>
            ...
            <LiProperty>
              ...
              (softwares) do Brow Extension Pro 4.0, de seus fornecedores ou
          ...
          <Link
            ...
            className="mt-6 uppercase inline-block rounded-full bg-brandBrowExtension hover:transition-colors hover: hover:bg-yellow-600 px-5 py-3 text-sm font-medium text-yellow-950"
          >
            voltar para o site
          </Link>
        </RootProperty>
