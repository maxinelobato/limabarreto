...
export function HeroCard(props: HeroCardProps) {
  return (
    <div className="bg-black/60 backdrop-blur-sm max-w-fit rounded-lg card-compact h-auto w-full min-w-full">
...
export function HeroCardText(props: HeroCardTextProps) {
  return <div className="text-center sm:text-left text-white" {...props} />
}
...
export function HeroCardH1(props: HeroCardH1Props) {
  return (
    <h1
      className="mt-0 sm:mt-4 pb-2 text-lg uppercase font-extrabold text-brandGenograma drop-shadow-lg md:text-3xl"
      {...props}
    />
  )
}
